...
/*!***********************************!*\
  ...
  \***********************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){for(var e=document.querySelectorAll(".accordion-heading"),o=document.querySelectorAll(".accordion-block"),s=function(s){var t=!1;e[s].addEventListener("click",function(){t?(o[s].style.display="none",t=!1):(o.forEach(function(e){return e.style.display="none"}),o[s].style.display="block",o[s].classList.add("animated"),o[s].classList.add("fadeInDown"),e.forEach(function(e){return e.classList.remove("active")}),e[s].classList.add("active"),t=!0)})},t=0;t<e.length;t++)s(t)}},"./src/js/parts/burgermenu.js":
/*!************************************!*\
