...
/*!*****************************************************!*\
  ...
  \*****************************************************/
/*! no static exports found */function(e,o,s){"use strict";var t,n,r,u,c=s(/*! ./_library */"./node_modules/core-js/modules/_library.js"),d=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),l=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),i=s(/*! ./_classof */"./node_modules/core-js/modules/_classof.js"),a=s(/*! ./_export */"./node_modules/core-js/modules/_export.js"),m=s(/*! ./_is-object */"./node_modules/core-js/modules/_is-object.js"),j=s(/*! ./_a-function */"./node_modules/core-js/modules/_a-function.js"),f=s(/*! ./_an-instance */"./node_modules/core-js/modules/_an-instance.js"),_=s(/*! ./_for-of */"./node_modules/core-js/modules/_for-of.js"),p=s(/*! ./_species-constructor */"./node_modules/core-js/modules/_species-constructor.js"),v=s(/*! ./_task */"./node_modules/core-js/modules/_task.js").set,y=s(/*! ./_microtask */"./node_modules/core-js/modules/_microtask.js")(),h=s(/*! ./_new-promise-capability */"./node_modules/core-js/modules/_new-promise-capability.js"),b=s(/*! ./_perform */"./node_modules/core-js/modules/_perform.js"),g=s(/*! ./_user-agent */"./node_modules/core-js/modules/_user-agent.js"),x=s(/*! ./_promise-resolve */"./node_modules/core-js/modules/_promise-resolve.js"),w=d.TypeError,S=d.process,k=S&&S.versions,L=k&&k.v8||"",E=d.Promise,O="process"==i(S),T=function(){},P=n=h.f,q=!!function(){try{var e=E.resolve(1),o=(e.constructor={})[s(/*! ./_wks */"./node_modules/core-js/modules/_wks.js")("species")]=function(e){e(T,T)};return(O||"function"==typeof PromiseRejectionEvent)&&e.then(T)instanceof o&&0!==L.indexOf("6.6")&&-1===g.indexOf("Chrome/66")}catch(e){}}(),M=function(e){var o;return!(!m(e)||"function"!=typeof(o=e.then))&&o},A=function(e,o){if(!e._n){e._n=!0;var s=e._c;y(function(){for(var t=e._v,n=1==e._s,r=0,u=function(o){var s,r,u,c=n?o.ok:o.fail,d=o.resolve,l=o.reject,i=o.domain;try{c?(n||(2==e._h&&C(e),e._h=1),!0===c?s=t:(i&&i.enter(),s=c(t),i&&(i.exit(),u=!0)),s===o.promise?l(w("Promise-chain cycle")):(r=M(s))?r.call(s,d,l):d(s)):l(t)}catch(e){i&&!u&&i.exit(),l(e)}};s.length>r;)u(s[r++]);e._c=[],e._n=!1,o&&!e._h&&I(e)})}},I=function(e){v.call(d,function(){var o,s,t,n=e._v,r=R(e);if(r&&(o=b(function(){O?S.emit("unhandledRejection",n,e):(s=d.onunhandledrejection)?s({promise:e,reason:n}):(t=d.console)&&t.error&&t.error("Unhandled promise rejection",n)}),e._h=O||R(e)?2:1),e._a=void 0,r&&o.e)throw o.v})},R=function(e){return 1!==e._h&&0===(e._a||e._c).length},C=function(e){v.call(d,function(){var o;O?S.emit("rejectionHandled",e):(o=d.onrejectionhandled)&&o({promise:e,reason:e._v})})},F=function(e){var o=this;o._d||(o._d=!0,(o=o._w||o)._v=e,o._s=2,o._a||(o._a=o._c.slice()),A(o,!0))},H=function(e){var o,s=this;if(!s._d){s._d=!0,s=s._w||s;try{if(s===e)throw w("Promise can't be resolved itself");(o=M(e))?y(function(){var t={_w:s,_d:!1};try{o.call(e,l(H,t,1),l(F,t,1))}catch(e){F.call(t,e)}}):(s._v=e,s._s=1,A(s,!1))}catch(e){F.call({_w:s,_d:!1},e)}}};q||(E=function(e){f(this,E,"Promise","_h"),j(e),t.call(this);try{e(l(H,this,1),l(F,this,1))}catch(e){F.call(this,e)}},(t=function(e){this._c=[],this._a=void 0,this._s=0,this._d=!1,this._v=void 0,this._h=0,this._n=!1}).prototype=s(/*! ./_redefine-all */"./node_modules/core-js/modules/_redefine-all.js")(E.prototype,{then:function(e,o){var s=P(p(this,E));return s.ok="function"!=typeof e||e,s.fail="function"==typeof o&&o,s.domain=O?S.domain:void 0,this._c.push(s),this._a&&this._a.push(s),this._s&&A(this,!1),s.promise},catch:function(e){return this.then(void 0,e)}}),r=function(){var e=new t;this.promise=e,this.resolve=l(H,e,1),this.reject=l(F,e,1)},h.f=P=function(e){return e===E||e===u?new r(e):n(e)}),a(a.G+a.W+a.F*!q,{Promise:E}),s(/*! ./_set-to-string-tag */"./node_modules/core-js/modules/_set-to-string-tag.js")(E,"Promise"),s(/*! ./_set-species */"./node_modules/core-js/modules/_set-species.js")("Promise"),u=s(/*! ./_core */"./node_modules/core-js/modules/_core.js").Promise,a(a.S+a.F*!q,"Promise",{reject:function(e){var o=P(this);return(0,o.reject)(e),o.promise}}),a(a.S+a.F*(c||!q),"Promise",{resolve:function(e){return x(c&&this===u?E:this,e)}}),a(a.S+a.F*!(q&&s(/*! ./_iter-detect */"./node_modules/core-js/modules/_iter-detect.js")(function(e){E.all(e).catch(T)})),"Promise",{all:function(e){var o=this,s=P(o),t=s.resolve,n=s.reject,r=b(function(){var s=[],r=0,u=1;_(e,!1,function(e){var c=r++,d=!1;s.push(void 0),u++,o.resolve(e).then(function(e){d||(d=!0,s[c]=e,--u||t(s))},n)}),--u||t(s)});return r.e&&n(r.v),s.promise},race:function(e){var o=this,s=P(o),t=s.reject,n=b(function(){_(e,!1,function(e){o.resolve(e).then(s.resolve,t)})});return n.e&&t(n.v),s.promise}})},"./node_modules/core-js/modules/es6.regexp.replace.js":
/*!************************************************************!*\
...
/*!***********************************!*\
  ...
  \***********************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){for(var e=document.querySelectorAll(".accordion-heading"),o=document.querySelectorAll(".accordion-block"),s=function(s){e[s].addEventListener("click",function(){o.forEach(function(e){return e.style.display="none"}),o[s].style.display="block",o[s].classList.add("animated"),o[s].classList.add("fadeInDown"),e.forEach(function(e){return e.classList.remove("active")}),e[s].classList.add("active")})},t=0;t<e.length;t++)s(t)}},"./src/js/parts/burgermenu.js":
/*!************************************!*\
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var e=document.querySelector(".portfolio-menu"),o=e.querySelectorAll("li"),s=document.querySelector(".portfolio-wrapper"),t=document.querySelector(".portfolio-no"),n=s.querySelectorAll(".portfolio-block");e.addEventListener("click",function(e){if(e.target.matches("li"))if(o.forEach(function(e){return e.classList.remove("active")}),e.target.classList.add("active"),e.target.matches(".grandmother")||e.target.matches(".granddad"))s.style.display="none",t.style.display="block";else{t.style.display="none",s.style.display="flex",n.forEach(function(e){return e.style.display="none"});for(var r=0;r<n.length;r++)n[r].classList[2]!=e.target.classList[0]&&"all"!=e.target.classList[0]||(n[r].style.display="block")}})}},"./src/js/parts/forms.js":
/*!*******************************!*\
  !*** ./src/js/parts/forms.js ***!
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js"),s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js");o.default=function(){var e=document.querySelector(".popup-design form"),o=document.querySelector(".popup-consultation form"),s=document.querySelector(".consultation form"),t=document.querySelector(".popup-design .popup-content"),n=document.querySelector(".popup-consultation .popup-content"),r=document.querySelector(".consultation"),u=document.querySelector(".popup-consultation .popup-close"),c=document.querySelector(".popup-design .popup-close"),d=document.createElement("div");function l(t,n,r){t.addEventListener("submit",function(e){e.preventDefault(),n.appendChild(d);var o=new FormData(t);(function(e){return new Promise(function(s,t){var n=new XMLHttpRequest;n.open("POST","server.php"),n.setRequestHeader("Content-type","application/json; charset=utf-8");var r={};o.forEach(function(e,o){r[o]=e}),e=JSON.stringify(r),n.onreadystatechange=function(){n.readyState<4?s():4===n.readyState&&(200==n.status&&n.status<300?s():t())},n.send(e)})})(o).then(function(){return d.innerHTML="Идёт загрузка..."}).then(function(){t==s?d.innerHTML="Спасибо за заявку!":(t.style.display="none",d.innerHTML="Спасибо за заявку!")}).catch(function(){t==s?d.innerHTML="Произошла ошибка!":(t.style.display="none",d.innerHTML="Произошла ошибка!")})}),t!=e&&t!=o||r.addEventListener("click",function(){t.style.display="block",d.remove()})}d.classList.add("status"),l(e,t,c),l(o,n,u),l(s,r)}},"./src/js/parts/hoverimg.js":
/*!**********************************!*\
